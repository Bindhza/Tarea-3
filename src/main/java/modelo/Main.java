...
public class Main {
    public static void main(String[] args) {
         ...
         */
        //Demostramos que nuestra implementacion de comparable es correcta
        ArrayList<Moneda> monedatest = new ArrayList<>();
        monedatest.add(new Moneda100());
        monedatest.add(new Moneda500());
        monedatest.add(new Moneda100());
        monedatest.add(new Moneda100());
        monedatest.add(new Moneda1000());
        System.out.println(monedatest);
        Collections.sort(monedatest);
        System.out.println(monedatest);
